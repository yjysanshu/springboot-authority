package com.temp.permission.service.base;
...
public class BaseService {
    ...
    public User getCurrentUser() {
        ...
        String phone = RedisPoolUtil.get(token);
        return userMapper.queryOneByPhone(phone);
    }
    ...
    public OauthUser getUser() {
        ...
        String phone = RedisPoolUtil.get(token);
        return oauthUserMapper.queryOneByPhone(phone);
    }
